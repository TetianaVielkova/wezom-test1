...
const productReviews = document.getElementById('reviewsList');
...
const totalReviews = document.querySelector('.reviews__total');
...
const totalReviewsElements = document.querySelectorAll('.reviews__total');
